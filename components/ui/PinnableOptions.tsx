    ...
    <div className="relative">
      ...
      {open && (
        <>
          ...
          <div className="absolute start-0 mt-2 w-64 glass rounded-card shadow-floating z-50 p-1.5">
            {options.map((opt) => {
              ...
              return (
                ...
                >
                  ...
                  <button
                    ...
                    aria-label={
                      isPinned
                        ? t("ui.unpinOption", { label: opt.label })
                        : t("ui.pinOption", { label: opt.label })
                    }
                    title={isPinned ? t("ui.unpin") : t("ui.pinAsButton")}
                  >
