...
const SIZES: { key: WidgetSize; label: string; icon: typeof Square }[] = [
  { key: "quarter", label: t("ui.sizeQuarter"), icon: Square },
  { key: "half", label: t("ui.sizeHalf"), icon: Columns2 },
  { key: "full", label: t("ui.sizeFullWidth"), icon: LayoutGrid },
];
        ...
        createPortal(
          <AnimatePresence>
            {at && (
              <motion.div
                role="menu"
                aria-label={t("ui.widgetOptions", { label })}
              ...
              >
                <div className="px-3.5 py-2.5 border-b border-hairline">
                  <div className="text-caption text-secondary">{t("ui.widget")}</div>
