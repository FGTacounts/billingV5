...
export const CUSTOMER_ALIASES: Record<string, string[]> = {
  ...
  // ISO two-letter country, which decides the VAT zone.
  country_code: ["country"],
  // Whose customer it is — matched by name or username against the staff list.
  salesman: ["salesman_name", "sales_exec", "sales", "rep", "salesperson"],
  is_active: ["active"],
};
...
export const ORDER_ALIASES: Record<string, string[]> = {
  ...
  po_number: ["po", "po_no", "po_#", "lpo", "lpo_no", "lpo_number", "purchase_order"],
