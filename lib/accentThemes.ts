...
export const ACCENT_THEMES: AccentTheme[] = [
  { key: "green", label: t("settings.accentGreen"), accent: "#2fc494", accentStrong: "#23a37c" },
  { key: "blue", label: t("settings.accentBlue"), accent: "#3b82f6", accentStrong: "#2563eb" },
  { key: "purple", label: t("settings.accentPurple"), accent: "#8b5cf6", accentStrong: "#7c3aed" },
  { key: "coral", label: t("settings.accentCoral"), accent: "#f0653e", accentStrong: "#d94f2b" },
  { key: "amber", label: t("settings.accentAmber"), accent: "#e0a12a", accentStrong: "#c78a1a" },
  { key: "teal", label: t("settings.accentTeal"), accent: "#14b8a6", accentStrong: "#0d9488" },
];

export const DEFAULT_ACCENT_THEME = ACCENT_THEMES[0];

export function findAccentTheme(key: string | null | undefined): AccentTheme {
  return ACCENT_THEMES.find((at) => at.key === key) ?? DEFAULT_ACCENT_THEME;
}
