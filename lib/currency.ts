...
export const SUPPORTED_CURRENCIES = [
  { code: "AED", label: t("documents.currencyAed") },
  { code: "USD", label: t("documents.currencyUsd") },
  { code: "EUR", label: t("documents.currencyEur") },
  { code: "GBP", label: t("documents.currencyGbp") },
  { code: "INR", label: t("documents.currencyInr") },
  { code: "SAR", label: t("documents.currencySar") },
  { code: "PKR", label: t("documents.currencyPkr") },
  { code: "PHP", label: t("documents.currencyPhp") },
  { code: "EGP", label: t("documents.currencyEgp") },
] as const;
