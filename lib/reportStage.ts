...
export const REPORT_STAGE_OPTIONS = [
  {
    ...
    label: t("documents.reportStageApprovedLabel"),
    hint: t("documents.reportStageApprovedHint"),
  },
  {
    value: "delivering" as const,
    label: t("documents.reportStageDeliveringLabel"),
    hint: t("documents.reportStageDeliveringHint"),
  },
  {
    value: "delivered" as const,
    label: t("documents.reportStageDeliveredLabel"),
    hint: t("documents.reportStageDeliveredHint"),
  },
];
