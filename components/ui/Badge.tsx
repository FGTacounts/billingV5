...
const ORDER_STATUS_LABEL: Record<OrderStatus, string> = {
  draft: t("ui.orderStatusDraft"),
  pending: t("ui.orderStatusPending"),
  rejected: t("ui.orderStatusRejected"),
  accepted: t("ui.orderStatusAccepted"),
  waiting: t("ui.orderStatusWaiting"),
  picking: t("ui.orderStatusPicking"),
