    ...
    >
      <div className="flex items-center justify-between mb-2 px-1 h-9">
        {expanded && (
          ...
          <img src={logoUrl} alt={t("nav.brandLogoAlt")} className="h-7 w-auto shrink-0" />
        )}
        <button
          ...
          aria-label={collapsed ? t("nav.pinSidebarOpen") : t("nav.collapseSidebar")}
        >
      ...
      {items
        ...
        .map((item) => {
          const active = isNavItemActive(item, items, pathname, searchParams);
