...
import { isNavItemActive, MAX_PRIMARY_NAV, type NavItem } from "@/lib/nav";
...
export default function MobileNav({
  ...
  const isActive = (item: NavItem) =>
    isNavItemActive(item, [...primary, ...secondary], pathname, searchParams);
        ...
        >
          ...
          >
            <div className="flex items-center justify-between px-5 py-4 border-b border-hairline">
              <span className="text-headline font-semibold">{t("nav.others")}</span>
              <button onClick={() => setMoreOpen(false)} aria-label={t("common.close")}>
