  ...
  return (
    <>
      ...
      {hidden && (
        <button
          onClick={scrollToTop}
          className="fixed bottom-20 md:bottom-6 end-6 z-40 w-11 h-11 rounded-full bg-accent text-white shadow-lg grid place-items-center hover:bg-accent-strong transition-transform active:scale-95"
